...
insert into ##car //NOMODIFICA
    (       
        ...
        carrello."numero dav",
        trans."tipo",
        trans."valor"*(CASE WHEN ((carrello2."codice transazione" = '' or carrello2."codice transazione" IS NULL) and (carrello2."pagato" = TRUE)) THEN 0 ELSE carrello2."totale" END)/(CASE trans."total_trans" WHEN 0 THEN 1 END),
        carrello2."codice cliente",
        trans."cod_filiale",
        carrello2."totale"
...
insert into ##car //NOMODIFICA
    (       
        ...
        csinal."descrizione",
        csinal."quantita",
        (csinal."prezzo" * -1)*(carrello2."prezzo")/(CASE soma_car."soma_prezzo" WHEN 0 THEN 1 END),
        csinal."sconto",
        (csinal."totale" * -1)*(carrello2."totale")/(CASE soma_car."soma_totale" WHEN 0 THEN 1 END),
        carrello2."operatore",
        csinal."filiale",
        ...
        '',
        trans."tipo",
        trans."valor"*((csinal."totale" * -1)*(carrello2."totale")/(CASE soma_car."soma_totale" WHEN 0 THEN 1 END))/(CASE trans."total_trans" WHEN 0 THEN 1 END),
...
insert into ##car //NOMODIFICA
    (                          
        ...
        scsinal."descrizione",
        scsinal."quantita",
        (scsinal."prezzo")*(storicocarrello2."prezzo")/(CASE soma_scar."soma_prezzo" WHEN 0 THEN 1 END),
        scsinal."sconto",
        (scsinal."totale")*(storicocarrello2."totale")/(CASE soma_scar."soma_totale" WHEN 0 THEN 1 END),
        storicocarrello2."operatore",
        scsinal."filiale",
        ...
        '',
        trans."tipo",
        trans."valor"*((scsinal."totale")*(storicocarrello2."totale")/(CASE soma_scar."soma_prezzo" WHEN 0 THEN 1 END))/(CASE trans."total_trans" WHEN 0 THEN 1 END),
...
insert into ##car //NOMODIFICA
    (                          
        ...
        scestorn."quantita",
        (scestorn."prezzo")*(storicocarrello2."prezzo")/(CASE soma_scestorno."soma_prezzo" WHEN 0 THEN 1 END),
        scestorn."sconto",
        (scestorn."totale")*(storicocarrello2."totale")/(CASE soma_scestorno."soma_totale" WHEN 0 THEN 1 END),
        storicocarrello2."operatore",
        scestorn."filiale",
        ...
        '',
        trans."tipo",
        trans."valor"*((scestorn."totale")*(storicocarrello2."totale")/(CASE soma_scestorno."soma_totale" WHEN 0 THEN 1 END))/(CASE trans."total_trans" WHEN 0 THEN 1 END),
...
insert into ##car //NOMODIFICA
    (                          
        ...
        scsinal."descrizione",
        scsinal."quantita",
        (scsinal."prezzo")*(carrello2."prezzo")/(CASE soma_scar."soma_prezzo" WHEN 0 THEN 1 END),
        scsinal."sconto",
        (scsinal."totale")*(carrello2."totale")/(CASE soma_scar."soma_totale" WHEN 0 THEN 1 END),
        carrello2."operatore",
        scsinal."filiale",
        scsinal."codice magazzino",
        scsinal."tipo fornitura dettaglio",
        ...
        '',
        trans."tipo",
        trans."valor"*((scsinal."totale")*(carrello2."totale")/(CASE soma_scar."soma_totale" WHEN 0 THEN 1 END))/(CASE trans."total_trans" WHEN 0 THEN 1 END),
        scsinal."codice cliente",
        trans."cod_filiale",
        0
...
insert into ##car //NOMODIFICA
    (                          
        ...
        scestorn."descrizione",
        scestorn."quantita",
        (scestorn."prezzo")*(carrello2."prezzo")/(CASE soma_scestorno."soma_prezzo" WHEN 0 THEN 1 END),
        scestorn."sconto",
        (scestorn."totale")*(carrello2."totale")/(CASE soma_scestorno."soma_totale" WHEN 0 THEN 1 END),
        carrello2."operatore",
        scestorn."filiale",
        scestorn."codice magazzino",
        scestorn."tipo fornitura dettaglio",
        ...
        '',
        trans."tipo",
        trans."valor"*((scestorn."totale")*(carrello2."totale")/(CASE soma_scestorno."soma_totale" WHEN 0 THEN 1 END))/(CASE trans."total_trans" WHEN 0 THEN 1 END),
        scestorn."codice cliente",
        trans."cod_filiale",
        0
